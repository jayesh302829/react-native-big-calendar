    ...
    render: function () {
        ...
        return (React.createElement(View, { style: [styles.desktop, theme === 'dark' && tailwind('bg-gray-900')] },
            ...
            React.createElement(View, { style: { marginTop: 16 } },
                React.createElement(Calendar, { date: date, height: SCREEN_HEIGHT - 80, events: calendarEvents, onPressCell: addEvent, mode: mode, theme: themes[theme] }))));
    },
};
//# sourceMappingURL=full-customization.stories.js.map