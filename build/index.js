...
var InfinitePager = require('react-native-infinite-pager');
...
var InfinitePager__default = /*#__PURE__*/_interopDefaultLegacy(InfinitePager);
...
function modeToNum(mode, current, amount) {
    ...
    if (mode === 'month') {
        ...
        var currentDate = current instanceof Date ? dayjs__default["default"](current) : current;
...
function enrichEvents(events, eventsAreSorted) {
    ...
    eventsWithOverlaps.forEach(function (event, index) {
        ...
        if (startDate === endDate) {
            ...
            eventsByDate[startDate].push(__assign(__assign({}, enrichedEvent), { end: dayjs__default["default"](enrichedEvent.start).endOf('day').toDate() }));
            ...
            eventsByDate[endDate].push(__assign(__assign({}, enrichedEvent), { start: dayjs__default["default"](enrichedEvent.end).startOf('day').toDate() }));
        }
    });
    return eventsByDate;
}
...
var _HourGuideCell = function (_a) {
    ...
    return (React__namespace.createElement(reactNative.TouchableWithoutFeedback, __assign({ onLongPress: function () { return onLongPress(date.hour(hour).minute(0)); }, onPress: function () { return onPress(date.hour(hour).minute(0)); } }, calendarCellAccessibilityProps),
        React__namespace.createElement(reactNative.View, { style: [
            ...
            ] }, Array.from({ length: timeslots }, function (_, index) { return (React__namespace.createElement(reactNative.View, { key: "".concat(index, "-").concat(date.toDate()), style: [
                u['border-l'],
                u['border-b'],
                {
...
function _CalendarBody(_a) {
    ...
    var _renderEvents = React__namespace.useCallback(function (date) {
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            ...
            enrichedEvents
                .filter(function (_a) {
                var start = _a.start, end = _a.end;
                return dayjs__default["default"](start).isBefore(date.startOf('day')) && dayjs__default["default"](end).isAfter(date.endOf('day'));
            })
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(reactNative.ScrollView, { style: [
                {
                    height: containerHeight - cellHeight * 3,
                },
                style,
            ], ref: scrollView, scrollEventThrottle: 32, showsVerticalScrollIndicator: showVerticalScrollIndicator, nestedScrollEnabled: true, contentOffset: reactNative.Platform.OS === 'ios' ? { x: 0, y: scrollOffsetMinutes } : { x: 0, y: 0 } },
            React__namespace.createElement(reactNative.View, { style: [u['flex-1'], theme.isRTL ? u['flex-row-reverse'] : u['flex-row']] },
...
function _CalendarBodyForMonthView(_a) {
    ...
    var sortedEvents = React__namespace.useCallback(function (day) {
        ...
        var filteredEvents = events
            .filter(function (_a) {
            var start = _a.start, end = _a.end;
            return dayjs__default["default"](end).isAfter(day.startOf('week')) && dayjs__default["default"](start).isBefore(max);
        })
            .sort(function (a, b) {
        ...
        for (var _i = 0, filteredEvents_1 = filteredEvents; _i < filteredEvents_1.length; _i++) {
            ...
            if (dayjs__default["default"](end).isAfter(min) && dayjs__default["default"](start).isBefore(min)) {
                min = dayjs__default["default"](start).startOf('day');
            }
        }
        filteredEvents = filteredEvents
            .filter(function (_a) {
            var start = _a.start, end = _a.end;
            return dayjs__default["default"](end).endOf('day').isAfter(min) && dayjs__default["default"](start).isBefore(max);
        })
            .reverse();
        /**
        ...
        while (!tmpDay.isAfter(day)) {
            for (var _b = 0, filteredEvents_2 = filteredEvents; _b < filteredEvents_2.length; _b++) {
                ...
                if (dayjs__default["default"](event.end).isBefore(tmpDay.startOf('day'))) {
                    var eventToMoveUp = filteredEvents.find(function (e) {
                        return dayjs__default["default"](e.start).startOf('day').isSame(tmpDay.startOf('day'));
                    });
    ...
    return (React__namespace.createElement(reactNative.View, { style: [
        ...
        } }, weeks.map(function (week, i) { return (React__namespace.createElement(reactNative.View, { key: "".concat(i, "-").concat(week.join('-')), style: [
            u['flex-1'],
        ...
        showWeekNumber ? (React__namespace.createElement(reactNative.View, __assign({ style: [
                i > 0 && u['border-t'],
                { borderColor: theme.palette.gray['200'] },
                u['p-2'],
                u['w-20'],
        ...
        week
            ...
            .map(function (date, ii) { return (React__namespace.createElement(reactNative.TouchableOpacity, __assign({ onLongPress: function () { return date && onLongPressCell && onLongPressCell(date.toDate()); }, onPress: function () { return date && onPressCell && onPressCell(date.toDate()); }, style: [
                i > 0 && u['border-t'],
            ...
            React__namespace.createElement(reactNative.TouchableOpacity, __assign({ onPress: function () {
                    return date &&
                        (onPressDateHeader
            ...
            React__namespace.createElement(TouchableGradually, __assign({ style: {
...
function _CalendarHeader(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, __assign({ style: [
        ...
        (!hideHours || showWeekNumber) && (React__namespace.createElement(reactNative.View, { style: [u['z-10'], u['w-50'], u['pt-2'], borderColor] }, showWeekNumber ? (React__namespace.createElement(reactNative.View, __assign({ style: [
                { height: cellHeight },
        ...
        dateRange.map(function (date) {
            ...
            return (React__namespace.createElement(reactNative.TouchableOpacity, __assign({ style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPressHeader(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() }, headerCellAccessibilityProps),
                React__namespace.createElement(reactNative.View, { style: [
                        { height: cellHeight },
                        objHasContent(headerContentStyle) ? headerContentStyle : u['justify-between'],
                    ] },
...
function _CalendarHeaderForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, __assign({ style: [
        ...
        showWeekNumber ? (React__namespace.createElement(reactNative.View, __assign({ style: [u['w-20'], { paddingTop: 2 }], key: 'weekNumber' }, headerCellAccessibilityProps),
    ...
    var renderFlatListItem = function (eventGroup, index) {
        ...
        return (React__default["default"].createElement(reactNative.View, { style: [u.flex, { padding: 2, flexWrap: 'wrap' }] },
            ...
            React__default["default"].createElement(reactNative.View, { style: [u.flex, u['justify-center'], { width: '20%' }] },
                React__default["default"].createElement(reactNative.View, __assign({ style: [
...
function _CalendarContainer(_a) {
    ...
    var _24 = React__default["default"].useState(function () { return dayjs__default["default"](date); }), targetDate = _24[0], setTargetDate = _24[1];
    React__default["default"].useEffect(function () {
        if (dateString) {
    ...
    var getCurrentDate = React__default["default"].useCallback(function (page) {
    ...
    if (mode === 'month') {
        ...
        return (React__default["default"].createElement(InfinitePager__default["default"], { ref: calendarRef, style: { flex: 1 }, pageWrapperStyle: { flex: 1 }, renderPage: function (_a) {
                var index = _a.index;
                return (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(HeaderComponentForMonthView, __assign({}, headerProps_1, { dateRange: getDateRange(getCurrentDate(index)) })),
    ...
    return (React__default["default"].createElement(InfinitePager__default["default"], { ref: calendarRef, renderPage: function (_a) {
            var index = _a.index;
            return (React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement(HeaderComponent, __assign({}, headerProps, { dateRange: getDateRange(getCurrentDate(index)) })),
                React__default["default"].createElement(CalendarBody, __assign({}, commonProps, { dateRange: getDateRange(getCurrentDate(index)), style: bodyContainerStyle, containerHeight: height, events: daytimeEvents, eventCellStyle: eventCellStyle, eventCellAccessibilityProps: eventCellAccessibilityProps, eventCellTextColor: eventCellTextColor, calendarCellStyle: calendarCellStyle, calendarCellAccessibilityProps: calendarCellAccessibilityProps, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, minHour: minHour, maxHour: maxHour, showTime: showTime, onLongPressCell: onLongPressCell, onPressCell: function (date) {
                        var _a;
                        onPressCell === null || onPressCell === void 0 ? void 0 : onPressCell(date);
                        if (mode !== 'day') {
                            (_a = calendarRef.current) === null || _a === void 0 ? void 0 : _a.setPage(0, { animated: true });
