...
function useCalendarTouchableOpacityProps(_a) {
    ...
    var _onLongPress = React__default.useCallback(function () {
...
function _CalendarBody(_a) {
    ...
    var _renderMappedEvent = React.useCallback(function (event, index) {
        return (React.createElement(CalendarEvent, { key: "".concat(index).concat(event.start).concat(event.title).concat(event.end), event: event, onPressEvent: onPressEvent, onLongPressEvent: onLongPressEvent, eventCellStyle: eventCellStyle, eventCellAccessibilityProps: eventCellAccessibilityProps, eventCellTextColor: eventCellTextColor, showTime: showTime, eventCount: event.overlapCount, eventOrder: event.overlapPosition, overlapOffset: overlapOffset, renderEvent: renderEvent, ampm: ampm, maxHour: maxHour, minHour: minHour, hours: hours.length }));
    }, [
        ampm,
        eventCellStyle,
        eventCellTextColor,
...
function _CalendarEventForMonthView(_a) {
    ...
    return (React.createElement(TouchableOpacity, { style: [{ minHeight: eventMinHeightForMonthView }, u['mt-2']], onPress: function () { return !event.disabled && (onPressEvent === null || onPressEvent === void 0 ? void 0 : onPressEvent(event)); }, onLongPress: function () {
            if (!event.disabled) {
...
function _CalendarHeader(_a) {
    ...
    var _onLongPressEvent = React.useCallback(function (event) {
        ...
        dateRange.map(function (date) {
            return (React.createElement(TouchableOpacity, __assign({ style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPressHeader(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() }, headerCellAccessibilityProps),
                ...
                showAllDayEventCell ? (React.createElement(View, { style: [
                    ...
                    return (React.createElement(TouchableOpacity, __assign({ style: [eventCellCss.style, primaryBg, u['mt-2'], getEventStyle(event)], key: "".concat(index, "-").concat(event.start, "-").concat(event.title, "-").concat(event.end), onPress: function () { return _onPressEvent(event); }, onLongPress: function () {
